...
class KNNOptunaStrategy(Strategy):
    """K-Nearest Neighbors strategy with Optuna hyperparameter optimization"""
    ...
    def _clean_data(self, df):
        """Remove NaN and infinity values - KNN requires clean data"""
        df_clean = df.copy()
    ...
    def generate_signal(self, past_data, current_data):
        ...
        # Clean data - KNN requires clean data
