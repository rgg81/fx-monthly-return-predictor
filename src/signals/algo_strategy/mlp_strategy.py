...
class MLPOptunaStrategy(Strategy):
    """Multi-Layer Perceptron strategy with Optuna hyperparameter optimization"""
    ...
    def _clean_data(self, df):
        """Remove NaN and infinity values - MLP requires clean data"""
        df_clean = df.copy()
    ...
    def fit(self, X, y):
        ...
        def objective(trial, InputFeatures, y_label, seed_random):
            params = {
                'hidden_layer_sizes': (
                    ...
                    trial.suggest_int('hidden_layer_size2', 10, 100),
                ),
        ...
        hidden_layer_sizes = (
            best_params.pop('hidden_layer_size1'),
            best_params.pop('hidden_layer_size2')
        )
    ...
    def generate_signal(self, past_data, current_data):
        ...
        # Clean data - MLP requires clean data
